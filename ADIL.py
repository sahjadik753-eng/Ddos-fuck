#!/usr/bin/env python3
"""
Telegram Bot Username Copier - Fixed for Termux
"""
...
class BotUsernameCopier:
    ...
    async def create_clone(self, analysis, clone_dir, new_token):
        ...
        for file_info in analysis['files']:
            ...
            if new_token:
                ...
                if old_token:
                    content = re.sub(rf'["\']{re.escape(old_token)}["\']', f'"{new_token}"', content)
    ...
    async def copy_bot(self, bot_username, new_token=None):
